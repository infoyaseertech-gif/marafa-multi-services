...
const pending = sales.filter((s) => s.status === "Pending").reduce((a, s) => a + (Number(s.amount) || 0), 0);
...
document.getElementById("page-content").innerHTML = `
  ...
  <div class="kpi-grid">
    ...
    <div class="kpi-card"><div class="kpi-label">Pending Receivables</div><div class="kpi-value" style="color:#c9962c">${fmtNaira(pending)}</div></div>
  </div>
